...
news.forEach(article => {
    ...
    const gameImgEl = document.createElement('img');
    gameImgEl.classList.add('gameImg');
    gameImgEl.src = article.headerBgSrc;
    gameCard.alt = `${article.category}`
